    ...
    <div class="editor-package-wrapper">
      ...
      <div class="editor-top">
        ...
        <button type="button"
                ...
                @click="insertText('upload')"></button>
        <!-- 代码块 -->
        <button type="button"
        ...
        <button type="button"
                ...
                @click="clearValue"
                title="代码块 (ctrl+ backspace)"></button>
      </div>
      <div class="editor-bottom flex-start">
        <div class="editor-bottom-edit">
          <pre class="editor-bottom-edit-pre">{{ value }}</pre>
          <textarea class="editor-bottom-edit-input"
                    v-model="value"
                    ref="textarea"></textarea>
        </div>
        <div class="editor-bottom-view editor-bottom-common "
...
pre {
  ...
  font-family: Menlo, "Ubuntu Mono", Consolas, "Courier New", "Microsoft Yahei",
    "Hiragino Sans GB", "WenQuanYi Micro Hei", sans-serif !important;
}
.hljs-keyword {
